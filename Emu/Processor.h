...
public:
    ...
    {
        RegisterSixteenBit* HL;
        RegisterSixteenBit* SP;
        RegisterSixteenBit* PC;
        RegisterSixteenBit* AF;
        RegisterSixteenBit* BC;
        RegisterSixteenBit* DE;
        bool* Halt;
        bool* IME; 
    };
...
private:
    ...
    void StackPush(RegisterSixteenBit* reg);
    void StackPop(RegisterSixteenBit* reg);
    int AdjustedCycles(int cycles);
    void InvalidOPCode();
    void OPCodes_LD(RegisterEightBit* reg1, uint8_t reg2);
    void OPCodes_LD(RegisterEightBit* reg, uint16_t address);
    void OPCodes_LD(uint16_t address, uint8_t reg);
    void OPCodes_OR(uint8_t number);
    void OPCodes_XOR(uint8_t number);
    void OPCodes_AND(uint8_t number);
    void OPCodes_CP(uint8_t number);
    void OPCodes_INC(RegisterEightBit* reg);
    void OPCodes_INC_HL();
    void OPCodes_DEC(RegisterEightBit* reg);
    void OPCodes_DEC_HL();
    void OPCodes_ADD(uint8_t number);
    void OPCodes_ADC(uint8_t number);
    void OPCodes_SUB(uint8_t number);
    void OPCodes_SBC(uint8_t number);
    void OPCodes_ADD_HL(uint16_t number);
    void OPCodes_ADD_SP(int8_t number);
    void OPCodes_SWAP_Register(RegisterEightBit* reg);
    void OPCodes_SWAP_HL();
    void OPCodes_SLA(RegisterEightBit* reg);
    void OPCodes_SLA_HL();
    void OPCodes_SRA(RegisterEightBit* reg);
    void OPCodes_SRA_HL();
    void OPCodes_SRL(RegisterEightBit* reg);
    void OPCodes_SRL_HL();
    void OPCodes_RLC(RegisterEightBit* reg, bool isRegisterA = false);
    void OPCodes_RLC_HL();
    void OPCodes_RL(RegisterEightBit* reg, bool isRegisterA = false);
    void OPCodes_RL_HL();
    void OPCodes_RRC(RegisterEightBit* reg, bool isRegisterA = false);
    void OPCodes_RRC_HL();
    void OPCodes_RR(RegisterEightBit* reg, bool isRegisterA = false);
    void OPCodes_RR_HL();
    void OPCodes_BIT(RegisterEightBit* reg, int bit);
    void OPCodes_BIT_HL(int bit);
    void OPCodes_SET(RegisterEightBit* reg, int bit);
    void OPCodes_SET_HL(int bit);
    void OPCodes_RES(RegisterEightBit* reg, int bit);
